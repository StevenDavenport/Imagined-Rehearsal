...
setuptools.setup(
    name='imagined-rehearsal',
    version='0.1.0',
    author='Steven Davenport',
    description='Reference implementation of Imagined Rehearsal for world-model agents, built on DreamerV3',
    url='https://github.com/StevenDavenport/Imagined-Rehearsal',
