...
def test_rlscape_experiment_registry_is_unique_and_well_formed():
  ...
  assert ids == [
      ...
      'stage4a', 'stage4b', 'stage5a', 'stage5b', 'stage5b1', 'stage5b2',
      'stage5c', 'stage5d', 'stage5e', 'stage6']
  assert all(re.fullmatch(r'stage\d+[a-z]?\d*', item) for item in ids)
...
def test_ready_stages_have_runners_protocols_but_no_completion_claims():
  ...
  assert {item['id'] for item in ready} == {
      'stage5a', 'stage5b', 'stage5b1', 'stage5b2', 'stage5c'}
  for item in ready:
