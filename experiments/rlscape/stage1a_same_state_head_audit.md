# RLScape Stage 1A: Same-State Goal-Conditioned Head Audit

**Status:** Complete. The canonical result is factual event recognition with
weak counterfactual goal selectivity and a severely overoptimistic critic.
...
```bash
python scripts/rlscape_stage1a_head_audit.py \
