...
> **Archived protocol.** This document predates the reservoir run and later
> diagnostic stages. Its settings and historical labels are preserved, but
> current names and status are maintained in the
> [canonical experiment registry](../README.md).
